      ...
      <div className='fixed flex flex-col gap-2 left-0 p-2 bg-white rounded-r-lg'>
          <a href="https://github.com/gergogyulai/main">
            <div className=' hover:opacity-60'>
              <svg aria-hidden="true" height="24" viewBox="0 0 16 16" version="1.1" width="24" data-view-component="true" class="octicon octicon-repo ActionListItem-visual ActionListItem-visual--leading">
